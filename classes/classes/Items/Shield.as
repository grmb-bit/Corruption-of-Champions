...
public class Shield extends Useable //Equipable
	{
		...
		override public function canUse():Boolean {
			...
			else if ((game.player.weaponPerk == "Large" && game.player.hasPerk(PerkLib.GigantGrip) == false) || game.player.weaponPerk == "Massive" || game.player.weaponPerk == "Dual Small" || game.player.weaponPerk == "Dual" || game.player.weaponPerk == "Dual Large") {
			...
			else if (game.player.shieldPerk == "Massive" && game.player.hasPerk(PerkLib.GigantGrip) == false) {
