...
public class TatteredScroll extends Consumable {
	...
	override public function useItem():Boolean {
		...
		if (player.hairColor == "sandy blonde" && player.hasPerk(PerkLib.TransformationImmunity) == false && player.hasPerk(PerkLib.Undeath) == false && player.hasPerk(PerkLib.WendigoCurse) == false) {
