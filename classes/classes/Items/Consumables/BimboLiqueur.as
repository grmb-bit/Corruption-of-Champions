...
public class BimboLiqueur extends Consumable {
		...
		override public function canUse():Boolean {
			if (!game.player.hasPerk(PerkLib.FutaForm) && !game.player.hasPerk(PerkLib.TransformationImmunity) && !game.player.hasPerk(PerkLib.Undeath) && !game.player.hasPerk(PerkLib.WendigoCurse)) return true;
