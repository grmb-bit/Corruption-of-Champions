...
public function buildmisc1Menu():void {
	...
	if (flags[kFLAGS.CAMP_UPGRADES_KITSUNE_SHRINE] == 3) {
		if (player.hasPerk(PerkLib.StarSphereMastery) == false && !(player.hasItem(useables.GLDSTAT))) addButtonDisabled(2, "Shrine", "You need to have Kitsune Statue and your own Star Sphere to finish the shrine!");
