...
private function aikoFootjob():void
	...
	+(player.hasPerk(PerkLib.Masochist) == false ? "Before you can protest, ":"")+"Aiko begins to increase the speed of her degrading footjob, kneading your groin firmly and forcing a weak groan from your throat. Tongues of vile purple flame begin to lick around her sole, coating your groin in an unbearable warmth. You cringe from the near-scalding heat of the flame, but your pain soon turns to pleasure. "+(player.hasPerk(PerkLib.Masochist) == false ? "A look of horror graces your face as you realize that her flames are turning you into a masochist!":"")+"\n\n"
...
private function aikoWhipping():void {
	...
	if (rand(4)==0) {
		...
		+"When you come to about an hour later, Aiko is nowhere to be seen. Your muscles are agonizingly sore, but you already know you’ll be a bit tougher for the ordeal.[if(player.hasPerk(PerkLib.Masochist) == false ) You shudder a little, remembering with disgust how willingly you subjected yourself to this treatment.]");
		player.orgasm('Vagina');
...
public function yamataLoses():void {
	...
	+(player.hasPerk(PerkLib.Masochist) == false ?(flags[kFLAGS.YAMATA_MASOCHIST] >= 100 ?"You realize that from all the torture Yamata has put you through, you have come to enjoy pain quite a lot. <b>You have become a masochist!</b>\n\n":"All that pain Yamata put you through almost drove you to masochism, but you defeated her before she could manage to drive you to such depraved thoughts!"):"")
	...
	if (player.hasPerk(PerkLib.Masochist) == false && flags[kFLAGS.YAMATA_MASOCHIST] >= 100)
