...
public function apparantlyJojoDOESlift():void
{
	...
	if (player.hasPerk(PerkLib.ControlledBreath) == false && player.hasPerk(PerkLib.CleansingPalm) == false && player.hasPerk(PerkLib.Enlightened) == false)
	{
	...
	else if (player.hasPerk(PerkLib.ControlledBreath) && player.hasPerk(PerkLib.CleansingPalm) == false && player.hasPerk(PerkLib.Enlightened) == false)
	{
	...
	else if (player.hasPerk(PerkLib.ControlledBreath) && player.hasPerk(PerkLib.CleansingPalm) && player.hasPerk(PerkLib.Enlightened) == false)
	{
