...
package classes.Scenes.NPCs 
{
	...
	public class Diana extends Monster
	{
		...
		public function SoulskillMod():Number {
			var mod3:Number = 1;
			if (hasPerk(PerkLib.DaoistCultivator)) mod3 += .1;
			if (hasPerk(PerkLib.DaoistApprenticeStage)) {
				if (hasPerk(PerkLib.SoulApprentice)) mod3 += .2;
				if (hasPerk(PerkLib.SoulPersonage)) mod3 += .2;
				if (hasPerk(PerkLib.SoulWarrior)) mod3 += .2;
			}
			return mod3;
		}
