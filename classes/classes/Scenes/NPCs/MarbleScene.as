...
//const MARBLE_MILKED_BEFORE:int = 1165;
		...
		public function timeChange():Boolean
		{
			...
			if (player.hasStatusEffect(StatusEffects.MarblesMilk) && player.hasPerk(PerkLib.MarblesMilk) == false) {
			...
			if (player.statusEffectv3(StatusEffects.Marble) > 0 && player.hasPerk(PerkLib.MarbleResistant) == false && player.hasPerk(PerkLib.MarblesMilk) == false && player.statusEffectv2(StatusEffects.Marble) > 25) {
		...
		public function timeChangeLarge():Boolean {
			...
			if (player.statusEffectv3(StatusEffects.Marble) > 0 && player.statusEffectv2(StatusEffects.Marble) < 25 && player.hasPerk(PerkLib.MarblesMilk) == false && player.hasPerk(PerkLib.MarbleResistant) == false && model.time.hours == 6) {
				spriteSelect(41);
			...
			if (player.statusEffectv3(StatusEffects.Marble) > 0 && player.statusEffectv2(StatusEffects.Marble) >= 100 && player.hasPerk(PerkLib.MarblesMilk) == false && player.hasPerk(PerkLib.MarbleResistant) == false && model.time.hours == 6) {
				spriteSelect(41);
...
public function marbleStatusChange(affection:Number, addiction:Number, isAddicted:Number = -1):void {
	...
	if(player.hasPerk(PerkLib.MarblesMilk) == false && player.hasPerk(PerkLib.MarbleResistant) == false) {
...
private function talkWithMarbleAtCamp():void {
	...
	else if(flags[kFLAGS.MARAE_QUEST_COMPLETE] >= 1 && flags[kFLAGS.FACTORY_SHUTDOWN] == 2 && flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 4)
	{
		...
		if(player.hasPerk(PerkLib.MaraesGiftFertility) == false && player.hasPerk(PerkLib.MaraesGiftStud) == false) {
