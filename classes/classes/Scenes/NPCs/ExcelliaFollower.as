...
public function ExcelliaCampFixHerHerself():void {
	...
	if (flags[kFLAGS.EXCELLIA_RECRUITED] > 32) {
		...
		outputText("You can't imagine what that was like for her. To be used and fucked by Minotaurs day in and day out as a mindless cumdump. "+(player.hasPerk(PerkLib.MinotaurCumAddict) ? "Though thinking about it again, maybe it wouldn't be as bad as you originally thought. ":"")+"The cowgirl gives you a sad smile.\n\n");
