			...
			if (!sophieAtCamp()) { //Could be at the farm or still in the wild
				...
				if (pregnancy.isPregnant) {
					...
					if (flags[kFLAGS.SOPHIE_HEAT_COUNTER] == 0) { //Tick over into heat if appropriate
						...
						if (model.time.hours == 10 && (player.hasPerk(PerkLib.LuststickAdapted) == false || rand(3) == 0) && sophieBimbo.bimboSophie() && !sophieBimbo.sophieIsInSeason() && flags[kFLAGS.SOPHIE_CAMP_EGG_COUNTDOWN] == 0 && !prison.inPrison) {
