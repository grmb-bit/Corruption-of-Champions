...
private function insultTheKaijuFirstMeeting():void {
	...
	if(kaijuCock()) {
		...
		if(player.hasStatusEffect(StatusEffects.KnowsWhitefire) && (player.hasPerk(PerkLib.BloodMage) == false && player.mana < combat.spellCostWhite(40))) {
...
private function badEndPartTwo():void {
	...
	if(player.hasCock()) outputText("  More tentacles arrive and begin to wrap around your [cocks], slowly jacking you off to the tempo set by the cocks in your ass and mouth, wracking you with further pleasure.");
